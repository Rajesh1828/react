    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await fetch('http://192.168.1.163:8093/admin/register', {
                ...
                body: JSON.stringify({ email, password, userName, role, address, mobileNo }),
            });
    ...
    return (
        <div className="container20">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type="number" className='box' placeholder="Enter your Mobile Number" required value={mobileNo} onChange={handleMobileNoChange} />
                <label>Address *</label>
